...
/* ARM CM0+ */
    ...
    /* UART_GPS_SCB_IRQ */
    const cy_stc_sysint_t UART_GPS_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)UART_GPS_SCB_IRQ__INTC_CORTEXM0P_MUX,
        .cm0pSrc = (cy_en_intr_t)UART_GPS_SCB_IRQ__INTC_NUMBER,
        .intrPriority = UART_GPS_SCB_IRQ__INTC_CORTEXM0P_PRIORITY
    };
    ...
    const cy_stc_sysint_t Echo_IRQ_cfg = {
        ...
        .cm0pSrc = (cy_en_intr_t)Echo_IRQ__INTC_NUMBER,
        .intrPriority = Echo_IRQ__INTC_CORTEXM0P_PRIORITY
    };
